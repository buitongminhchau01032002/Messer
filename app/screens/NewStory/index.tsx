import { HStack, View, useTheme, Image, Button, Text, VStack, Pressable } from 'native-base';
...
export const NewStoryScreen = (props: RootStackScreenProps<RootNavigatekey.NewStory>) => {
    ...
    return (
        <View flex={1} alignItems={'center'} justifyContent={'center'}>
            {!imageUrl ? (
                <Pressable onPress={() => pickImage()} background={'red.100'} padding={10}>
                    <VStack space={5}>
                        <ImageIcon color="primary.900" size="md" alignSelf={'center'} />
                        <Text alignSelf={'center'} bold>
                            Create your story for 24 hour
                        </Text>
                    </VStack>
                </Pressable>
            ) : (
