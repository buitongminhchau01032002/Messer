...
import { storeUserFromFirestore } from 'slice/auth';
...
export const ChangeInformationScreen = (props: RootStackScreenProps<RootNavigatekey.ChangeInfomation>) => {
    // navigation
        ...
        // const deviceToken = await getToken(messaging, { vapidKey: "BJJdsMAPga6bGAvN4k-pBmeEU9NZbuCD-k_-vZdUUruF-QmsO0oOTjTs9Nu27x7FNIyDuKPu_EhPEi2wZ4q6h5A" } )
            ...
            uploadBytes(storageRef, blob).then((snapshot) => {
                getDownloadURL(storageRef).then(async (url) => {
                    ...
                    dispatch(storeUserFromFirestore(newUser));
                    navigation.goBack()
